...
const auto strncmp = reinterpret_cast<int(*)(const char*, const char*, size_t)>(0x489B40);
const auto strcpy = reinterpret_cast<char* (*)(char*, const char*)>(0x481100);
const auto strncpy = reinterpret_cast<char* (*)(char*, const char*, size_t)>(0x486E90);
...
const auto calloc = reinterpret_cast<void* (*)(size_t, size_t)>(0x487701);
const auto realloc = reinterpret_cast<void* (*)(void*, size_t)>(0x48ADF2);
const auto _msize = reinterpret_cast<size_t(*)(void*)>(0x48AF9F);
